...
const LegalMentions = () => (
  ...
  <ul className="legal-mentions-list text">
    <li className="legal-mentions-list-item"><a href="https://www.linkedin.com/in/ines-mouandjo-lobe/">Inès Mouandjo Lobé</a> | Product Owner & Scrum Master</li>
    <li className="legal-mentions-list-item"><a href="https://www.linkedin.com/in/guillaume-terrien/">Guillaume Terrien</a> | Product Owner & Lead Dev Back</li>
    <li className="legal-mentions-list-item"><a href="https://www.linkedin.com/">Claudine Brun</a> | Lead Dev Front</li>
    <li className="legal-mentions-list-item"><a href="https://www.linkedin.com/in/guillaume-ersent-15419a17b/">Guillaume Ersent</a> | Référent Technique</li>
  </ul>
</section>
  </>
);
